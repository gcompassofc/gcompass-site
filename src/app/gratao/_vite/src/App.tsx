import { Play, Eye, ArrowRight, ArrowDown, Calendar, Map, Check, X, Quote, MessagesSquare, Laptop, UserCheck, CreditCard, Clock, Receipt, EyeOff } from 'lucide-react';
...
const FadeIn = ({ children, delay = 0, className = "" }: { children: React.ReactNode, delay?: number, className?: string }) => (
  <motion.div
    ...
    transition={{ duration: 0.7, delay, ease: [0.16, 1, 0.3, 1] }} // smooth ease out
    className={className}
  >
    {children}
  </motion.div>
    ...
    <div className="min-h-screen font-sans selection:bg-cyan-500 selection:text-[#050B14] overflow-hidden" 
      ...
      <section className="relative w-full pt-16 md:pt-28 pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full z-0">
          <div className="absolute inset-0 bg-[#080A0F]/70 z-10"></div> {/* Overlay escuro */}
          ...
          >
            {/* Como o link fornecido é de uma página, adicionei o elemento de vídeo pronto. 
                Para funcionar o vídeo, coloque o link direto do arquivo .mp4 aqui ou faça o upload e aponte o src */}
        ...
        <div className="container-premium">
          <FadeIn delay={0.4} className="relative w-full max-w-5xl mx-auto group cursor-pointer mt-0">
            ...
            <div className="hero-image bg-[#05080C] border border-white/[0.08] flex flex-col items-center justify-center text-white/40 hover:text-white/90 transition-all duration-500 aspect-[16/10] sm:aspect-[21/9] relative overflow-hidden shadow-2xl">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center opacity-15 mix-blend-overlay group-hover:opacity-25 transition-opacity duration-700 decoration-none"></div>
      ...
      {/* SEÇÃO 2 — O ESPELHO (Dor + Consciência) */}
      ...
      {/* SEÇÃO 3 — AS VOZES REAIS (Prova emocional) */}
      <section className="bg-[#05080C] border-t border-white/[0.02]">
        <div className="container-premium">
          ...
          <div className="grid-3">
            {[
              {
                text: "Se pudesse voltar, voltaria. Faria diferente. Mas o tempo passou e me deixou a experiência.",
                author: "Avanísio, 60 anos"
              },
              {
                text: "Eu achava que minha aposentadoria ia ser ótima. Quando cheguei lá, cadê meu dinheiro?",
                author: "Bete, 74 anos"
              },
              {
                text: "Dois anos desempregado. Trabalhei arriscando a minha vida e de repente não tenho nada.",
                author: "Rosier, 62 anos"
              }
            ].map((quote, i) => (
              <div key={i}>
                <FadeIn delay={i * 0.1}>
      ...
      {/* SEÇÃO 5 — O QUE VOCÊ ENCONTRA AQUI DENTRO (Solução) */}
      <section className="bg-[#0A0D14] border-t border-white/[0.02]">
        <div className="container-premium">
      ...
      {/* SEÇÃO 6 — OS INIMIGOS (Ritmo Quebrado, Editorial) */}
      <section className="bg-[#080A0F] border-t border-white/[0.02]">
        <div className="container-premium">
            ...
            <FadeIn delay={0.1}>
              <div className="h-full border border-white/[0.05] bg-[#0A0D14] rounded-[24px] p-8 md:p-12 relative overflow-hidden group">
                ...
                <div className="w-full aspect-[2/1] bg-[#05080C] rounded-xl border border-white/[0.05] mb-10 overflow-hidden relative flex items-center justify-center">
                  ...
                  {/* Central Element focusing on debt */}
            ...
            <FadeIn delay={0.2}>
              <div className="h-full border border-white/[0.05] bg-[#0A0D14] rounded-[24px] p-8 md:p-12 relative overflow-hidden group">
                ...
                <div className="w-full aspect-[2/1] bg-[#05080C] rounded-xl border border-white/[0.05] mb-10 overflow-hidden relative flex items-center justify-center">
                  ...
                  {/* Central Element focusing on procrastination */}
                  <div className="absolute inset-0 flex items-center justify-center z-20">
              ...
              <div className="card h-full justify-between">
                <div>
                  ...
                  <ul className="space-y-5 mb-12">
                    {[
                      "Acesso básico à comunidade aberta",
                      "Encontros seletos ao vivo",
