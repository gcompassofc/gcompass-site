...
>(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-principal bg-principal text-white px-8 py-3 shadow-[0px_4px_24px_rgba(140,35,35,0.4)] transition-all hover:bg-destaque",
        className
      )}
      {...props}
    />
